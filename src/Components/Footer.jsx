...
export default function Footer() {
  return (
    ...
    <footer className="bg-darkTeal text-white py-10">
            ...
            <ul className="space-y-2">
              <li>
                <a className="hover:underline" href="#">
                  <MdKeyboardDoubleArrowLeft className="arrow-icon"/><span>الرئيسية</span>
                </a>
              </li>
              <li>
                <a className="hover:underline" href="#">
                   <MdKeyboardDoubleArrowLeft className="arrow-icon" /> <span>تقديم شكوى</span>
                </a>
              </li>
              <li>
                <a className="hover:underline" href="#">
                   <MdKeyboardDoubleArrowLeft className="arrow-icon"/> <span>الأسئلة الشائعة</span>
                </a>
              </li>
              <li>
                <a className="hover:underline" href="#">
                   <MdKeyboardDoubleArrowLeft className="arrow-icon"/> <span>سياسة الخصوصية</span>
                </a>
              </li>
            </ul>
          </div>
        ...
        {/* footer-bottom*/}
        <div className="mt-10 text-center border-t border-gray-600 pt-4 text-sm text-gray-400 mx-10">
