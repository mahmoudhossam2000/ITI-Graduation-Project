            ...
            <div className="hidden md:flex items-center space-x-3">
              ...
              {currentUser ? (
                <>
                  <Link
                    to="/profile"
                    className="px-4 py-2 border border-blue-500 text-blue rounded-md text-sm font-medium flex items-center gap-1 hover:bg-blue-500 hover:text-white transition-colors hover:bg-blue hover:text-white"
                  >
