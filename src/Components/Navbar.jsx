        ...
        <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-2">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center space-x-3">
              <Link
                to="/"
                className="text-blue hover:text-blue-600 px-3 py-2 rounded-md text-base font-medium flex items-center gap-1 transition-colors hover:text-blue"
              >
              ...
              {currentUser ? (
                <>
                  <Link
                    to="/profile"
                    className="px-4 py-2 border border-blue-500 text-blue rounded-md text-sm font-medium flex items-center gap-1 hover:bg-blue-500 hover:text-white transition-colors hover:text-white hover:bg-blue"
                  >
